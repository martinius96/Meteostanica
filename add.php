<?php
 include ("connect.php");
$temp1 = mysqli_real_escape_string($con, $_GET['temp1']);
$t2 = mysqli_real_escape_string($con, $_GET['tempinside']);
$p = mysqli_real_escape_string($con, $_GET['pressure']);
$h = mysqli_real_escape_string($con, $_GET['humidity']);
